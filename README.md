...
### Возможности:
- проигрывание mp3, ogg, flac файлов.
...
- Сделать автозагрузку. (RECEIVE_BOOT_COMPLETED и QUICKBOOT_POWERON не работают т.к. для автозагрузки необходимо, чтобы приложение было в белом списке).
